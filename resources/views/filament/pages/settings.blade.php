    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
      <div>
        ...
        <x-filament::input.wrapper class="w-full">
          <x-filament::input type="text" wire:model.defer="currency" id="currency" class="w-full" />
      ...
      <div>
        ...
        <x-filament::input.wrapper class="w-full">
          <x-filament::input.select wire:model.defer="timezone" id="timezone" class="w-full">
